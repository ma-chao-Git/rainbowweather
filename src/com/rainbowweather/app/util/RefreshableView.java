...
public class RefreshableView extends LinearLayout implements OnTouchListener {
	...
	public RefreshableView(Context context, AttributeSet attrs) {
		...
		header = LayoutInflater.from(context).inflate(R.layout.pull_to_refresh_layout, null, true);
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		if (changed && !loadOnce) {
			...
			mainMenu = (RelativeLayout)getChildAt(1);
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		if (ableToPull) {
			...
			if (currentStatus == STATUS_PULL_TO_REFRESH
				...
				mainMenu.setFocusableInTouchMode(false);
	...
	private void setIsAbleToPull(MotionEvent event) {
		View firstChild = mainMenu.getChildAt(0);
		if (firstChild != null) {
//			int firstVisiblePos = mainMenu.getFirstVisiblePosition(); firstVisiblePos == 0 && 
